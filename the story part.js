let story = {
    intro : {
        text : `You take a step off the scale. You have gained a lot of weight. 
    ...
    offer2 : {
        ...
        You awaken in a dark void anfd you hear a man say 
        "Looks like you're going to the shadow realm jimbo"`
    },
    street2 : {
        text:`A wild Chaka Chooka has apeared. 
        A powerfull beast, known around the world for taking down 
    ...
    street3 : {
        text:`As you walk down the street you see a massive battle off in the distance. You walk closer to see what it is about. You see an army of  pschopathic clowns led by Ronald Mcdonald and another army of inbred hillbillys led by Wendy. Unfortunatley for you had your burger king t-shirt on that day. Both factions stop and notice you. As if they had formed an unspoken truce they begin to attack you.`,
        choices : [
            ["Ora Ora Ora",""],
            [,],
            [,]
